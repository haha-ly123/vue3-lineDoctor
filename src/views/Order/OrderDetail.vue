...
const OrderDetailApi = async () => {
    const { data } = await getMedicalOrderDetail(route.params.id as string)
...
<template>
    <div class="order-detail-page" v-if="order">
        ...
        <div class="order-head">
            <div class="address" v-if="order.status === OrderType.MedicineCancel ||
        ...
        <div class="order-detail">
            <van-cell-group>
                ...
                <template v-if="order.status === OrderType.MedicineSend ||
